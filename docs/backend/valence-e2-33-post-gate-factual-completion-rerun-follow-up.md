...
Выполнить follow-up rerun factual completion-аудита после предыдущего post-gate шага.

## Что сделано

1. Выполнен run:
   - `scripts/ml/valence_e2_25_execute_factual_weekly_cycle_audit.py` с output dir `e2-33-post-gate-factual-completion-rerun-follow-up`.
