...
Для всех modeling- и personalization-шагов этот формат считается минимальным. Расширенный и обязательный для исполнения research-grade стандарт с визуализациями, machine-readable artifacts и multi-model comparison policy зафиксирован в `docs/research/model-reporting-standard.md`.
...
6. обязательную ссылку на `docs/research/model-reporting-standard.md` для всех следующих modeling-, personalization- и comparative-report шагов.
